...
class GetSnapshotsTask extends ConcurrentTask {
    ...
    protected void doTask(String eventName) {
        try {
            Assertions.assertThat(ConcurrencyTestBase.subject.getSnapshot()).isNotNull();
            ...
            Assertions.assertThat(ConcurrencyTestBase.subject.getAllSamplesSnapshot()).isNotNull();
        } catch (Throwable t) {
            failed = true;
