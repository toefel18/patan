...
public abstract class ConcurrencyTestBase {
	...
	private void setupTestForAllSampleMethods(int occurrenceThreads,
		...
		addConcurrentTasks(TaskFactory.OCCURRENCE_TASK_FACTORY, OCCURRENCE_NAME, occurrenceThreads, loopsPerThread);
		addConcurrentTasks(TaskFactory.OCCURRENCES_TASK_FACTORY, OCCURRENCES_NAME, occurrenceThreads, loopsPerThread);
		addConcurrentTasks(TaskFactory.SAMPLE_TASK_FACTORY, SAMPLE_NAME, sampleThreads, loopsPerThread);
		addConcurrentTasks(TaskFactory.DURATION_TASK_FACTORY, DURATION_NAME, durationThreads, loopsPerThread);
		addConcurrentTasks(TaskFactory.GET_SNAPSHOT_TASK_FACTORY, "", snapshotThreads, loopsPerThread);
		addConcurrentTasks(TaskFactory.FIND_SAMPLE_DISTRIBUTION_TASK_FACTORY, SAMPLE_NAME, threadsPerFindMethod, loopsPerThread);
		addConcurrentTasks(TaskFactory.FIND_OCCURRENCE_TASK_FACTORY, OCCURRENCE_NAME, threadsPerFindMethod, loopsPerThread);
		addConcurrentTasks(TaskFactory.FIND_DURATION_TASK_FACTORY, DURATION_NAME, threadsPerFindMethod, loopsPerThread);
	...
	private void setupTestForResetMethods(int writerThreads,
		...
		concurrentTasks = new ArrayList<ConcurrentTask>();
		addConcurrentTasks(TaskFactory.OCCURRENCE_TASK_FACTORY, OCCURRENCE_NAME, writerThreads, loopsPerThread);
		addConcurrentTasks(TaskFactory.SAMPLE_TASK_FACTORY, SAMPLE_NAME, writerThreads, loopsPerThread);
		addConcurrentTasks(TaskFactory.DURATION_TASK_FACTORY, DURATION_NAME, writerThreads, loopsPerThread);

		addConcurrentTasks(TaskFactory.RESET_SNAPSHOT_TASK_FACTORY, "", resetThreads, loopsPerResetThread);
		addConcurrentTasks(TaskFactory.RESET_ALLDURATIONS_SNAPSHOT_TASK_FACTORY, "", resetThreads, loopsPerResetThread);
		addConcurrentTasks(TaskFactory.RESET_ALLOCCURRENCE_SNAPSHOT_TASK_FACTORY, "", resetThreads, loopsPerResetThread);
		addConcurrentTasks(TaskFactory.RESET_ALLSAMPLES_SNAPSHOT_TASK_FACTORY, "", resetThreads, loopsPerResetThread);
