...
import nl.toefel.java.code.measurements.api.StatisticsFacade;
import nl.toefel.java.code.measurements.api.Stopwatch;

import java.util.Map;

public class Statistics implements StatisticsFacade {

	private StatisticalRecordStore statsStore = new StatisticalRecordStore();
	...
	public Map<String, Statistic> getSnapshot() {
		return statsStore.getSnapshot();
	}

	@Override
	public Map<String, Statistic> getSnapshotAndReset() {
		return statsStore.getSnapshotAndReset();
	}
